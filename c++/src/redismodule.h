// This file is copied from Redis 5.0.0, and I splited the original header into
...
extern int REDISMODULE_API_FUNC(RedisModule_CreateCommand)(RedisModuleCtx* ctx, const char* name,
                                                           RedisModuleCmdFunc cmdfunc,
                                                           const char* strflags, int firstkey,
                                                           int lastkey, int keystep);
extern void REDISMODULE_API_FUNC(RedisModule_SetModuleAttribs)(RedisModuleCtx* ctx,
                                                               const char* name, int ver,
                                                               int apiver);
extern int REDISMODULE_API_FUNC(RedisModule_IsModuleNameBusy)(const char* name);
...
extern void* REDISMODULE_API_FUNC(RedisModule_OpenKey)(RedisModuleCtx* ctx,
...
extern int REDISMODULE_API_FUNC(RedisModule_ListPush)(RedisModuleKey* kp, int where,
                                                      RedisModuleString* ele);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_ListPop)(RedisModuleKey* key, int where);
extern RedisModuleCallReply* REDISMODULE_API_FUNC(RedisModule_Call)(RedisModuleCtx* ctx,
                                                                    const char* cmdname,
                                                                    const char* fmt, ...);
extern const char* REDISMODULE_API_FUNC(RedisModule_CallReplyProto)(RedisModuleCallReply* reply,
                                                                    size_t* len);
...
extern RedisModuleCallReply* REDISMODULE_API_FUNC(RedisModule_CallReplyArrayElement)(
    RedisModuleCallReply* reply, size_t idx);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_CreateString)(RedisModuleCtx* ctx,
                                                                         const char* ptr,
                                                                         size_t len);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_CreateStringFromLongLong)(
    RedisModuleCtx* ctx, long long ll);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_CreateStringFromString)(
    RedisModuleCtx* ctx, const RedisModuleString* str);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_CreateStringPrintf)(RedisModuleCtx* ctx,
                                                                               const char* fmt,
                                                                               ...);
extern void REDISMODULE_API_FUNC(RedisModule_FreeString)(RedisModuleCtx* ctx,
                                                         RedisModuleString* str);
extern const char* REDISMODULE_API_FUNC(RedisModule_StringPtrLen)(const RedisModuleString* str,
                                                                  size_t* len);
extern int REDISMODULE_API_FUNC(RedisModule_ReplyWithError)(RedisModuleCtx* ctx, const char* err);
extern int REDISMODULE_API_FUNC(RedisModule_ReplyWithSimpleString)(RedisModuleCtx* ctx,
                                                                   const char* msg);
...
extern int REDISMODULE_API_FUNC(RedisModule_ReplyWithStringBuffer)(RedisModuleCtx* ctx,
                                                                   const char* buf, size_t len);
extern int REDISMODULE_API_FUNC(RedisModule_ReplyWithString)(RedisModuleCtx* ctx,
                                                             RedisModuleString* str);
...
extern int REDISMODULE_API_FUNC(RedisModule_ReplyWithCallReply)(RedisModuleCtx* ctx,
                                                                RedisModuleCallReply* reply);
extern int REDISMODULE_API_FUNC(RedisModule_StringToLongLong)(const RedisModuleString* str,
                                                              long long* ll);
extern int REDISMODULE_API_FUNC(RedisModule_StringToDouble)(const RedisModuleString* str,
                                                            double* d);
extern void REDISMODULE_API_FUNC(RedisModule_AutoMemory)(RedisModuleCtx* ctx);
extern int REDISMODULE_API_FUNC(RedisModule_Replicate)(RedisModuleCtx* ctx, const char* cmdname,
                                                       const char* fmt, ...);
extern int REDISMODULE_API_FUNC(RedisModule_ReplicateVerbatim)(RedisModuleCtx* ctx);
extern const char* REDISMODULE_API_FUNC(RedisModule_CallReplyStringPtr)(RedisModuleCallReply* reply,
                                                                        size_t* len);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_CreateStringFromCallReply)(
    RedisModuleCallReply* reply);
extern int REDISMODULE_API_FUNC(RedisModule_DeleteKey)(RedisModuleKey* key);
extern int REDISMODULE_API_FUNC(RedisModule_UnlinkKey)(RedisModuleKey* key);
extern int REDISMODULE_API_FUNC(RedisModule_StringSet)(RedisModuleKey* key, RedisModuleString* str);
extern char* REDISMODULE_API_FUNC(RedisModule_StringDMA)(RedisModuleKey* key, size_t* len,
                                                         int mode);
...
extern int REDISMODULE_API_FUNC(RedisModule_ZsetAdd)(RedisModuleKey* key, double score,
                                                     RedisModuleString* ele, int* flagsptr);
extern int REDISMODULE_API_FUNC(RedisModule_ZsetIncrby)(RedisModuleKey* key, double score,
                                                        RedisModuleString* ele, int* flagsptr,
                                                        double* newscore);
extern int REDISMODULE_API_FUNC(RedisModule_ZsetScore)(RedisModuleKey* key, RedisModuleString* ele,
                                                       double* score);
extern int REDISMODULE_API_FUNC(RedisModule_ZsetRem)(RedisModuleKey* key, RedisModuleString* ele,
                                                     int* deleted);
extern void REDISMODULE_API_FUNC(RedisModule_ZsetRangeStop)(RedisModuleKey* key);
extern int REDISMODULE_API_FUNC(RedisModule_ZsetFirstInScoreRange)(RedisModuleKey* key, double min,
                                                                   double max, int minex,
                                                                   int maxex);
extern int REDISMODULE_API_FUNC(RedisModule_ZsetLastInScoreRange)(RedisModuleKey* key, double min,
                                                                  double max, int minex, int maxex);
extern int REDISMODULE_API_FUNC(RedisModule_ZsetFirstInLexRange)(RedisModuleKey* key,
                                                                 RedisModuleString* min,
                                                                 RedisModuleString* max);
extern int REDISMODULE_API_FUNC(RedisModule_ZsetLastInLexRange)(RedisModuleKey* key,
                                                                RedisModuleString* min,
                                                                RedisModuleString* max);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_ZsetRangeCurrentElement)(
...
extern int REDISMODULE_API_FUNC(RedisModule_GetContextFlags)(RedisModuleCtx* ctx);
extern void* REDISMODULE_API_FUNC(RedisModule_PoolAlloc)(RedisModuleCtx* ctx, size_t bytes);
extern RedisModuleType* REDISMODULE_API_FUNC(RedisModule_CreateDataType)(
    RedisModuleCtx* ctx, const char* name, int encver, RedisModuleTypeMethods* typemethods);
extern int REDISMODULE_API_FUNC(RedisModule_ModuleTypeSetValue)(RedisModuleKey* key,
                                                                RedisModuleType* mt, void* value);
...
extern void REDISMODULE_API_FUNC(RedisModule_EmitAOF)(RedisModuleIO* io, const char* cmdname,
                                                      const char* fmt, ...);
extern void REDISMODULE_API_FUNC(RedisModule_SaveString)(RedisModuleIO* io, RedisModuleString* s);
extern void REDISMODULE_API_FUNC(RedisModule_SaveStringBuffer)(RedisModuleIO* io, const char* str,
                                                               size_t len);
...
extern void REDISMODULE_API_FUNC(RedisModule_Log)(RedisModuleCtx* ctx, const char* level,
                                                  const char* fmt, ...);
extern void REDISMODULE_API_FUNC(RedisModule_LogIOError)(RedisModuleIO* io, const char* levelstr,
                                                         const char* fmt, ...);
extern int REDISMODULE_API_FUNC(RedisModule_StringAppendBuffer)(RedisModuleCtx* ctx,
                                                                RedisModuleString* str,
                                                                const char* buf, size_t len);
extern void REDISMODULE_API_FUNC(RedisModule_RetainString)(RedisModuleCtx* ctx,
                                                           RedisModuleString* str);
extern int REDISMODULE_API_FUNC(RedisModule_StringCompare)(RedisModuleString* a,
                                                           RedisModuleString* b);
...
extern void REDISMODULE_API_FUNC(RedisModule_DigestAddStringBuffer)(RedisModuleDigest* md,
                                                                    unsigned char* ele, size_t len);
extern void REDISMODULE_API_FUNC(RedisModule_DigestAddLongLong)(RedisModuleDigest* md,
                                                                long long ele);
extern void REDISMODULE_API_FUNC(RedisModule_DigestEndSequence)(RedisModuleDigest* md);
extern RedisModuleDict* REDISMODULE_API_FUNC(RedisModule_CreateDict)(RedisModuleCtx* ctx);
extern void REDISMODULE_API_FUNC(RedisModule_FreeDict)(RedisModuleCtx* ctx, RedisModuleDict* d);
extern uint64_t REDISMODULE_API_FUNC(RedisModule_DictSize)(RedisModuleDict* d);
extern int REDISMODULE_API_FUNC(RedisModule_DictSetC)(RedisModuleDict* d, void* key, size_t keylen,
                                                      void* ptr);
extern int REDISMODULE_API_FUNC(RedisModule_DictReplaceC)(RedisModuleDict* d, void* key,
                                                          size_t keylen, void* ptr);
extern int REDISMODULE_API_FUNC(RedisModule_DictSet)(RedisModuleDict* d, RedisModuleString* key,
                                                     void* ptr);
extern int REDISMODULE_API_FUNC(RedisModule_DictReplace)(RedisModuleDict* d, RedisModuleString* key,
                                                         void* ptr);
extern void* REDISMODULE_API_FUNC(RedisModule_DictGetC)(RedisModuleDict* d, void* key,
                                                        size_t keylen, int* nokey);
extern void* REDISMODULE_API_FUNC(RedisModule_DictGet)(RedisModuleDict* d, RedisModuleString* key,
                                                       int* nokey);
extern int REDISMODULE_API_FUNC(RedisModule_DictDelC)(RedisModuleDict* d, void* key, size_t keylen,
                                                      void* oldval);
extern int REDISMODULE_API_FUNC(RedisModule_DictDel)(RedisModuleDict* d, RedisModuleString* key,
                                                     void* oldval);
extern RedisModuleDictIter* REDISMODULE_API_FUNC(RedisModule_DictIteratorStartC)(RedisModuleDict* d,
                                                                                 const char* op,
                                                                                 void* key,
                                                                                 size_t keylen);
extern RedisModuleDictIter* REDISMODULE_API_FUNC(RedisModule_DictIteratorStart)(
    RedisModuleDict* d, const char* op, RedisModuleString* key);
extern void REDISMODULE_API_FUNC(RedisModule_DictIteratorStop)(RedisModuleDictIter* di);
extern int REDISMODULE_API_FUNC(RedisModule_DictIteratorReseekC)(RedisModuleDictIter* di,
                                                                 const char* op, void* key,
                                                                 size_t keylen);
extern int REDISMODULE_API_FUNC(RedisModule_DictIteratorReseek)(RedisModuleDictIter* di,
                                                                const char* op,
                                                                RedisModuleString* key);
extern void* REDISMODULE_API_FUNC(RedisModule_DictNextC)(RedisModuleDictIter* di, size_t* keylen,
                                                         void** dataptr);
extern void* REDISMODULE_API_FUNC(RedisModule_DictPrevC)(RedisModuleDictIter* di, size_t* keylen,
                                                         void** dataptr);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_DictNext)(RedisModuleCtx* ctx,
                                                                     RedisModuleDictIter* di,
                                                                     void** dataptr);
extern RedisModuleString* REDISMODULE_API_FUNC(RedisModule_DictPrev)(RedisModuleCtx* ctx,
                                                                     RedisModuleDictIter* di,
                                                                     void** dataptr);
extern int REDISMODULE_API_FUNC(RedisModule_DictCompareC)(RedisModuleDictIter* di, const char* op,
                                                          void* key, size_t keylen);
extern int REDISMODULE_API_FUNC(RedisModule_DictCompare)(RedisModuleDictIter* di, const char* op,
                                                         RedisModuleString* key);

/* Experimental APIs */
#ifdef REDISMODULE_EXPERIMENTAL_API
#define REDISMODULE_EXPERIMENTAL_API_VERSION 3
extern RedisModuleBlockedClient* REDISMODULE_API_FUNC(RedisModule_BlockClient)(
...
extern int REDISMODULE_API_FUNC(RedisModule_UnblockClient)(RedisModuleBlockedClient* bc,
                                                           void* privdata);
...
extern RedisModuleBlockedClient* REDISMODULE_API_FUNC(RedisModule_GetBlockedClientHandle)(
    RedisModuleCtx* ctx);
extern int REDISMODULE_API_FUNC(RedisModule_AbortBlock)(RedisModuleBlockedClient* bc);
extern RedisModuleCtx* REDISMODULE_API_FUNC(RedisModule_GetThreadSafeContext)(
...
extern int REDISMODULE_API_FUNC(RedisModule_SubscribeToKeyspaceEvents)(
    RedisModuleCtx* ctx, int types, RedisModuleNotificationFunc cb);
extern int REDISMODULE_API_FUNC(RedisModule_BlockedClientDisconnected)(RedisModuleCtx* ctx);
extern void REDISMODULE_API_FUNC(RedisModule_RegisterClusterMessageReceiver)(
    RedisModuleCtx* ctx, uint8_t type, RedisModuleClusterMessageReceiver callback);
extern int REDISMODULE_API_FUNC(RedisModule_SendClusterMessage)(RedisModuleCtx* ctx,
                                                                char* target_id, uint8_t type,
                                                                unsigned char* msg, uint32_t len);
extern int REDISMODULE_API_FUNC(RedisModule_GetClusterNodeInfo)(RedisModuleCtx* ctx, const char* id,
                                                                char* ip, char* master_id,
                                                                int* port, int* flags);
extern char** REDISMODULE_API_FUNC(RedisModule_GetClusterNodesList)(RedisModuleCtx* ctx,
                                                                    size_t* numnodes);
extern void REDISMODULE_API_FUNC(RedisModule_FreeClusterNodesList)(char** ids);
extern RedisModuleTimerID REDISMODULE_API_FUNC(RedisModule_CreateTimer)(
    RedisModuleCtx* ctx, mstime_t period, RedisModuleTimerProc callback, void* data);
extern int REDISMODULE_API_FUNC(RedisModule_StopTimer)(RedisModuleCtx* ctx, RedisModuleTimerID id,
                                                       void** data);
extern int REDISMODULE_API_FUNC(RedisModule_GetTimerInfo)(RedisModuleCtx* ctx,
                                                          RedisModuleTimerID id,
                                                          uint64_t* remaining, void** data);
extern const char* REDISMODULE_API_FUNC(RedisModule_GetMyClusterID)(void);
extern size_t REDISMODULE_API_FUNC(RedisModule_GetClusterSize)(void);
extern void REDISMODULE_API_FUNC(RedisModule_GetRandomBytes)(unsigned char* dst, size_t len);
extern void REDISMODULE_API_FUNC(RedisModule_GetRandomHexChars)(char* dst, size_t len);
extern void REDISMODULE_API_FUNC(RedisModule_SetDisconnectCallback)(
    RedisModuleBlockedClient* bc, RedisModuleDisconnectFunc callback);
extern void REDISMODULE_API_FUNC(RedisModule_SetClusterFlags)(RedisModuleCtx* ctx, uint64_t flags);
#endif
